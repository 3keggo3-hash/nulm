...
Feature matrix for Claude Bridge v0.1 (unreleased). Tracks implementation maturity and test coverage.
...
| Dashboard | `control_plane_dashboard.py` | Beta | Low | localhost web UI |
| AI evaluator | `ai_evaluator.py` | Beta | Medium | local/anthropic/openai/ollama providers |
