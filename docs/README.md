...
- `benchmarks/README.md` benchmark klasoruyle birlikte duran ozel bir kullanim rehberidir; benchmark materyaline yakin kalmasi gerekip gerekmedigi ayri degerlendirilmelidir.
